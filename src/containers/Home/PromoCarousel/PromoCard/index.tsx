...
const PromoCard = () => {
  return (
    <article className="bg-white shadow-lg rounded-xl overflow-hidden w-[500px] flex">
      ...
      <div className="flex-1 flex flex-col justify-center p-4">
        ...
        <div className="text-heading-4 text-gray-70 mb-4">Indonesia</div>
