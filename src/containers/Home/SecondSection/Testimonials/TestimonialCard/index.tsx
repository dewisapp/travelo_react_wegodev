  ...
  return (
    <article className="flex flex-col bg-white rounded-xl shadow w-[288px] h-[281px] p-4">
      ...
      <p className="text-heading-5 text-gray-70 my-4">
        Nyari makanan halal gampang banget sudah ada tour guidenya. tour
        guidenya juga ramah enak diajak ngobrol, dan penginapannya pun nyaman
      </p>
      ...
      <p className="text-heading-6 text-gray-50">12-09-2022</p>
    </article>
  );
};
