...
const PackageCard = () => {
  return (
    <article className="flex flex-col bg-white rounded-xl overflow-hidden w-[393px]">
      ...
      <div className="flex flex-col p-4">
        ...
        <p className="text-heading-4 text-gray-70 mb-4 font-label">Italia</p>
        <p className="text-heading-3 text-gray-70 mb-4">Rp. 20.000.000</p>
        <p className="text-heading-3 text-gray-70 mb-4">
          Untuk 1 Orang, tiket pesawat, penginapam 5 malam, tour guide, makan
